...
NS_INLINE void OF_dispatch_background_after_interval(NSTimeInterval interval, dispatch_block_t block) {
  OF_dispatch_after_interval(interval, dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), block);
}
